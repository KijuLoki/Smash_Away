...
public class TrackMyClaimsActivity extends AppCompatActivity
    ...
    LinearLayout head1, sub10, sub11;
    IconicsImageView house_icon1;
    boolean open1= false;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_track_my_claims);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.track_my_claims, menu);
        return true;
    }
